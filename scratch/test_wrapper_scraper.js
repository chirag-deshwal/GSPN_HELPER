...
const wrapperPath = path.join(__dirname, '../webpage_source/Interaction Messages_list_view_mode.html');
const mainPath = path.join(__dirname, '../webpage_source/Interaction Messages_list_view_mode_files/main.html');
...
console.log('Wrapper HTML records:', parseInteractionMessagesHtml(wrapperHtml).length);
console.log('Main HTML records:', parseInteractionMessagesHtml(mainHtml).length);
